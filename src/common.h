...
#ifndef __PASSTHROUGH_COMMON_H__
#define __PASSTHROUGH_COMMON_H__
...
typedef enum PortIndex
{
  ...
  PASSTHROUGH_CV_IN,
  PASSTHROUGH_AUDIO_IN,
  PASSTHROUGH_CONTROL_IN,
  PASSTHROUGH_CV_OUT,
  PASSTHROUGH_AUDIO_OUT,
  PASSTHROUGH_MIDI_OUT,
  NUM_PASSTHROUGH_PORTS,
} PortIndex;
